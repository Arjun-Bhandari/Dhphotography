...
module.exports.birthday = async (req, res) => {
    let allImages = await Image.find({ type: "birthday" });
    res.render("images/birthday.ejs", { allImages });
  };
  ...
  module.exports.renderEditPage =  async (req, res) => {
    ...
    res.render("edit_pages/birthday.edit.ejs", { image, originalImageUrl });
  };

  module.exports.updateBirthdayImages = async (req, res, next) => {
  ...
  module.exports.destroyBirthdayImages = async (req, res) => {
    let { id } = req.params;
